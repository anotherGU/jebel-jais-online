...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientCompany'] = "kQC9NMxQsnaCmE42haN8";
        $headers['auth']['clientSecret'] = "NzExNWtRQzlOTXhRc25hQ21FNDJoYU44Y2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
